...
export default function MarketerSection() {
  const { t } = useLang()
  const cards = [
    { num: '1', pain: t('marketer_card1_pain'), title: t('marketer_card1_title'), desc: t('marketer_card1_desc'), tags: [t('marketer_card1_tag1'), t('marketer_card1_tag2')] },
    { num: '2', pain: t('marketer_card2_pain'), title: t('marketer_card2_title'), desc: t('marketer_card2_desc'), tags: [t('marketer_card2_tag1'), t('marketer_card2_tag2')] },
    { num: '3', pain: t('marketer_card3_pain'), title: t('marketer_card3_title'), desc: t('marketer_card3_desc'), tags: [t('marketer_card3_tag1'), t('marketer_card3_tag2')] },
  ]
  ...
  return (
    <section data-skip-reveal className="py-24 px-6 md:px-12 w-full bg-black">
      <div ref={ref} className="max-w-7xl mx-auto">
        ...
        {/* 섹션 타이틀 */}
        <div className={`flex items-center gap-4 mb-8 ${baseTransition} ${reveal}`} style={style(0)}>
          <div className="w-8 h-[1px] bg-brand-yellow" />
          <span className="text-gray-400 font-bold text-sm tracking-widest">{t('marketer_tag')}</span>
        </div>
        <h2 className={`text-5xl md:text-[56px] font-black text-white leading-[1.1] mb-12 whitespace-pre-line ${baseTransition} ${reveal}`} style={style(80)}>
          {t('marketer_headline')}
        </h2>

        {/* 서브카피 */}
        <div className={`mb-12 ${baseTransition} ${reveal}`} style={style(180)}>
        ...
        {/* 하단 CTA */}
        <div className={`mt-8 bg-zinc-900 rounded-[2rem] p-8 md:p-10 shadow-[0_10px_40px_rgba(0,0,0,0.2)] border border-zinc-800 flex flex-col md:flex-row items-center justify-between gap-6 ${baseTransition} ${reveal}`} style={style(750)}>
          <div>
