...
const ko: Dict = {
  ...
  why_headline_1: '많이 뿌리는 게 아니라',
  why_headline_2: '정확하게',
  why_headline_3: '닿는 겁니다.',
  why_sub_1: '브랜드 페르소나에 맞춰 인플루언서를 선별하고,',
  why_sub_2: '무작위 시딩이 아닌 전략적으로 연결합니다.',
...
const en: Dict = {
  ...
  why_tag: 'Why Resonance ?',
  why_headline_1: "We don't just spray —",
  why_headline_2: 'we precisely',
  why_headline_3: 'reach the right ones.',
  why_sub_1: 'We select influencers that fit your brand persona,',
  why_sub_2: 'connecting strategically — not randomly.',
...
const ja: Dict = {
  ...
  why_tag: 'Why Resonance ?',
  why_headline_1: 'ばらまくのではなく、',
  why_headline_2: '的確に',
  why_headline_3: '届けます。',
  why_sub_1: 'ブランドのペルソナに合ったインフルエンサーを選び、',
  why_sub_2: '無作為ではなく戦略的につなげます。',
